...
public class Test {
	...
	public Test() {
		PersistenceUtil.setPersistenceUnitName("personInheritanceASingleTable");
	}
...
//		test.retrieveAPerson(1);
	...
	private void retrieveAPerson(int i) {
		...
		Person person = em.find(Employee.class, i);
	...
	public void retrieveAllPersons() {
		System.out.println("\nAll of the persons: ");
		EntityManager em = PersistenceUtil.getEntityManager();
		Query allPersons = em.createQuery("Select p from Director p");
		Collection<Employee> persons = allPersons.getResultList();
	...
	public void retrieveAllEmployees() {
		System.out.println("\nAll of the persons: ");
		EntityManager em = PersistenceUtil.getEntityManager();
		Query allPersons = em.createQuery("Select e from Employee e");
		Collection<Employee> persons = allPersons.getResultList();
		System.out.println(persons.size() + " objects:");

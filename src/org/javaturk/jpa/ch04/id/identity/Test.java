...
public class Test {
	...
	public Test() {
		PersistenceUtil.setPersistenceUnitName("identity");
	}

	public static void main(String[] args) {
		Test test = new Test();
		
		test.createPersonByIdentity();
		test.retrieveAllPersons();
	}

	/**
	 * This method persists entities to MS SQL Server
	 */
	private void createPersonByIdentity() {
		System.out.println("Creating a person with an id by IDENTITY");
